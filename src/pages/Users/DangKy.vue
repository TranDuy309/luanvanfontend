        ...
        <div class="container">
            ...
            <div class="form-row">
              <div class="form-group col-md-12">
                ...
                <input v-model="EMAIL" type="email" class="form-control" id="inputEmail4" placeholder="abc@gmail.com">
              </div>
            </div>
            <div class="form-row">
              <div class="form-group col-md-12">
            ...
            <div class="form-group col-md-7">
              <button @click.prevent="createNV()" style="align:center" class="btn btn-primary btn-fill float-right">Xác nhận</button>
            </div>
          </form>
                                </card>
                            </div>
